          ...
          <MotionWrap surface="benchmark">
            <div className="panel-card mx-auto max-w-3xl p-8 text-center md:p-10">
              ...
              <p className="mt-6">
                <Link
                  href="/"
                  className="inline-flex rounded-md border border-emerald-300/45 bg-emerald-300/10 px-4 py-2 text-sm font-semibold text-emerald-200 transition hover:border-emerald-200 hover:bg-emerald-300/20 hover:text-emerald-100"
                >
                  Back to landing
                </Link>
              </p>
            ...
            {batchThroughput.map((entry) => {
              const width =
                peakThroughput > 0
                  ...
                  : 0;
              const fill = PROFILE_COLORS[entry.profileId] ?? "bg-zinc-400/80";
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-right">
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="font-mono text-xs text-emerald-300 transition hover:text-emerald-200"
                      >
                        open
                      </a>
                    </td>
